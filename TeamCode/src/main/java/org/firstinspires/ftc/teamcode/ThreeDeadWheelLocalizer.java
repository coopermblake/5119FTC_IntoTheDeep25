...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 914.0956137636947; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1129.7443399423285; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 911.0844823276403; // x position of the perpendicular encoder (in tick units)
    }
